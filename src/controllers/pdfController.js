...
import formatCotizacionCode from "../utils/format.js";
/*
////////////////////////////////////////////////
CREACION DE PDF
////////////////////////////////////////////////
...
export const createPdf = async (req, res) => {
  try {
    const { quoteType, idCotizacion, numero, cliente, telefono, correo, domicilio, productos, subtotal, iva, total, date, nota,
      manoObra = [] } = req.body;
          ...
          stack: [
            {
              columns: [
                ...
                },
                {
                  alignment: "right",
                  text: [
                    { text: `${formatCotizacionCode(idCotizacion)}\n`, bold: true, fontSize: 14 },
                    { text: `${date}\n`, fontSize: 9 },
                  ],
                },
              ],
